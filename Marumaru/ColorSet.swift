...
enum ColorSet {
    ...
    static let appbarColor                  = UIColor(named: "AppbarColor")
    static let appbarTextColor              = UIColor(named: "AppbarTextColor")
    static let backgroundColor              = UIColor(named: "BackgroundColor")
    static let buttonBackgroundColor1       = UIColor(named: "ButtonBackgroundColor1")
    static let buttonBackgroundColor2       = UIColor(named: "ButtonBackgroundColor2")
    static let buttonBackgroundColor3       = UIColor(named: "ButtonBackgroundColor3")
    static let buttonForegroundColor        = UIColor(named: "ButtonForegroundColor")
    ...
    static let patternedTile                = UIColor.patternedColor
}
